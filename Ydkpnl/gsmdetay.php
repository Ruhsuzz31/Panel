...
<head>
    ...
    <title>GSM Detay Sorgulama</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        if (isset($_GET['gsmtc'])) {
            ...
            if ($response !== false) {
                ...
                // Gizli karakterleri temizleme (bu satır JSON parse hatası alıyorsanız eklenmeli, aksi takdirde gereksiz olabilir)
                ...
                if (json_last_error() !== JSON_ERROR_NONE) {
                    ...
                    // "success" anahtarını ve "Data" anahtarını kontrol et
                    if (isset($data['success']) && $data['success'] === true && isset($data['Data'])) {
                        ...
                        // Dinamik olarak tüm verileri tabloya ekle
