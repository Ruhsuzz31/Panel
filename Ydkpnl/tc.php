...
<body>
    <div class="container">
        ...
        if (isset($_GET['tc'])) {
            ...
            $url = "https://api.hexnox.pro/sowixapi/tcpro.php?tc=" . urlencode($tc);
            ...
            if ($response !== false) {
                ...
                // API çıktınızda 'data' anahtarı altında doğrudan tek bir dizi var gibi görünüyor.
                if (isset($data['data']) && is_array($data['data'])) {
                    $item = $data['data']; // Doğrudan veri nesnesini alıyoruz
                    ...
                    echo "<td>" . htmlspecialchars($item['AD'] ?? '') . "</td>";
                    echo "<td>" . htmlspecialchars($item['SOYAD'] ?? '') . "</td>";
